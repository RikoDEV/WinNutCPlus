namespace WinNUT.Core;

/// <summary>
/// Resolves where WinNUT stores its persistent data (settings, logs, crash reports).
/// </summary>
public static class AppPaths
{
    private const string AppFolderName = "WinNUT";

    /// <summary>
    /// %LocalAppData%\WinNUT by default. Pass a command-line arg of
