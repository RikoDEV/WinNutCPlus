...
using WinNUT.App.Localization;
using WinNUT.App.Services;
using WinNUT.App.ViewModels;
using WinNUT.App.Views;
using WinNUT.Core.Update;

namespace WinNUT.App;
...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            {
                ToastService.Send("WinNutCPlus", $"Imported {imported.FieldsImported} settings from your previous WinNUT installation.");
            }
    ...
    private void HandleCrash(Exception? exception)
    {
        ...
        var report = WinNUT.Core.Logging.CrashReporter.BuildReport(
